...
public class DetailSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.customToolbar.appToolbar.setTitle(title);
        ...
        binding.rvActivityDetailSearchList.setLayoutManager(new LinearLayoutManager(this));
    }
    ...
    void fetchHttp () throws JSONException {
        ...
        temp.put("type",title.toLowerCase());
